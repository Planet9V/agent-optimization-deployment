// GAP-004 Sample Data: UC2 Cyber-Physical Attack Detection (FIXED VERSION)
// File: gap004_sample_data_uc2_v2.cypher
// Created: 2025-11-13
// Modified: 2025-11-13 - Fixed nested map properties to JSON strings
...
CREATE (dt1:DigitalTwinState {
  ...
  expectedValues: '{"temperature":85.5,"pressure":120.3,"flowRate":450.0,"valvePosition":75,"actuatorCommand":"OPEN"}',
...
CREATE (dt2:DigitalTwinState {
  ...
  expectedValues: '{"rotationSpeed":1064,"temperature":35.5,"vibration":2.3,"bearingTemp":42.0}',
...
CREATE (dt3:DigitalTwinState {
  ...
  expectedValues: '{"flowRate":850.0,"pressure":95.2,"motorCurrent":23.5,"pumpSpeed":1750}',
...
CREATE (dt4:DigitalTwinState {
  ...
  expectedValues: '{"voltage":138000,"current":450.0,"temperature":78.5,"oilLevel":95.0}',
...
CREATE (dt5:DigitalTwinState {
  ...
  expectedValues: '{"temperature":1250.0,"pressure":1.02,"oxygenLevel":18.5,"fuelFlowRate":120.0}',
...
CREATE (dt6:DigitalTwinState {
  ...
  expectedValues: '{"temperature":21.5,"humidity":45.0,"airFlowRate":3500.0,"damperPosition":60}',
...
CREATE (dt7:DigitalTwinState {
  ...
  expectedValues: '{"inletPressure":850.0,"outletPressure":1200.0,"temperature":95.0,"vibration":3.5}',
...
CREATE (dt8:DigitalTwinState {
  ...
  expectedValues: '{"signalState":"GREEN","voltage":24.0,"current":0.8,"lampIntensity":95.0}',
...
CREATE (dt9:DigitalTwinState {
  ...
  expectedValues: '{"temperature":185.0,"pressure":12.5,"stirrerSpeed":350,"ph":7.2}',
...
CREATE (dt10:DigitalTwinState {
  ...
  expectedValues: '{"rotorSpeed":12.5,"powerOutput":2500.0,"windSpeed":15.0,"pitch":8.5}',
...
CREATE (sensor1:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":60.0,"low":70.0,"high":95.0,"highHigh":105.0}',
  customer_namespace: "customer:RailOperator-XYZ",
  is_shared: false
});
...
CREATE (sensor2:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":800.0,"low":900.0,"high":1200.0,"highHigh":1300.0}',
  customer_namespace: "customer:NuclearFacility-Alpha",
  is_shared: false
});
...
CREATE (sensor3:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":500.0,"low":600.0,"high":1000.0,"highHigh":1100.0}',
  customer_namespace: "customer:WaterUtility-Beta",
  is_shared: false
});
...
CREATE (sensor4:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":125000.0,"low":130000.0,"high":145000.0,"highHigh":150000.0}',
  customer_namespace: "customer:PowerGrid-Gamma",
  is_shared: false
});
...
CREATE (sensor5:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":0.8,"low":0.9,"high":1.2,"highHigh":1.3}',
  customer_namespace: "customer:SteelMill-Delta",
  is_shared: false
});
...
CREATE (sensor6:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":20.0,"low":30.0,"high":60.0,"highHigh":70.0}',
  customer_namespace: "customer:SmartBuilding-Epsilon",
  is_shared: false
});
...
CREATE (sensor7:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":0.0,"low":1.0,"high":5.0,"highHigh":7.0}',
  customer_namespace: "customer:GasPipeline-Zeta",
  is_shared: false
});
...
CREATE (sensor8:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":0.3,"low":0.5,"high":1.2,"highHigh":1.5}',
  customer_namespace: "customer:RailOperator-XYZ",
  is_shared: false
});
...
CREATE (sensor9:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":6.0,"low":6.5,"high":8.0,"highHigh":8.5}',
  customer_namespace: "customer:ChemPlant-Eta",
  is_shared: false
});
...
CREATE (sensor10:PhysicalSensor {
  ...
  alarmThresholds: '{"lowLow":0.0,"low":2.0,"high":15.0,"highHigh":20.0}',
  customer_namespace: "customer:WindFarm-Theta",
  is_shared: false
});
...
// ==============================================================================
// END OF UC2 SAMPLE DATA (FIXED VERSION)
// ==============================================================================
...
//
// FIXES APPLIED:
// - Converted all nested map properties to JSON strings
// - DigitalTwinState.expectedValues: map → JSON string
// - PhysicalSensor.alarmThresholds: map → JSON string
//
