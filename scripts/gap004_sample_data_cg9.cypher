// GAP-004 Sample Data: CG-9 Operational Impact Modeling
// File: gap004_sample_data_cg9.cypher
// Created: 2025-11-13
// Purpose: Realistic test data for CG-9 nodes (4 types, 10+ samples each)

// ==============================================================================
// CG-9 Node Type 1: OperationalMetric (10 samples)
// ==============================================================================

// Sample 1: Train Delays - Railway
CREATE (metric1:OperationalMetric {
...
// Sample 2: System Availability - SCADA
CREATE (metric2:OperationalMetric {
  metricId: "metric-scada-availability-20251113",
  ...
  target: 99.95,
  thresholdExceeded: true,
  aggregationPeriod: duration('PT24H'),
  trend: "DEGRADING",
  customer_namespace: "customer:RailOperator-XYZ",
  is_shared: false
});

// Sample 3: Water Flow Rate
CREATE (metric3:OperationalMetric {
  metricId: "metric-water-flow-20251113",
...
// Sample 4: Power Grid Response Time
CREATE (metric4:OperationalMetric {
  metricId: "metric-power-response-20251113",
  ...
  target: 50.0,
  thresholdExceeded: true,
  aggregationPeriod: duration('PT5M'),
  trend: "VOLATILE",
  customer_namespace: "customer:PowerGrid-Gamma",
  is_shared: false
});

// Sample 5: Manufacturing Error Rate
CREATE (metric5:OperationalMetric {
  metricId: "metric-mfg-error-rate-20251113",
...
// Sample 6: HVAC Capacity Utilization
CREATE (metric6:OperationalMetric {
  metricId: "metric-hvac-capacity-20251113",
  ...
  target: 80.0,
  thresholdExceeded: true,
  aggregationPeriod: duration('PT15M'),
  trend: "DEGRADING",
  customer_namespace: "customer:SmartBuilding-Epsilon",
  is_shared: false
});

// Sample 7: Gas Pipeline Throughput
CREATE (metric7:OperationalMetric {
  metricId: "metric-gas-throughput-20251113",
  metricType: "THROUGHPUT",
  value: 2500000.0,
  unit: "cubic_meters/hour",
...
// Sample 8: Passenger Count - Railway
CREATE (metric8:OperationalMetric {
  metricId: "metric-passenger-count-20251113",
  metricType: "PASSENGER_COUNT",
  value: 82800.0,
  unit: "passengers",
  timestamp: datetime('2025-11-13T15:30:00Z'),
  assetId: "train-network-central",
  target: 120000.0,
  thresholdExceeded: false,
  aggregationPeriod: duration('PT3H'),
  trend: "STABLE",
  customer_namespace: "customer:RailOperator-XYZ",
  is_shared: false
});

// Sample 9: Service Frequency - Railway
CREATE (metric9:OperationalMetric {
  metricId: "metric-service-frequency-20251113",
  metricType: "SERVICE_FREQUENCY",
  value: 6.0,
  unit: "trains/hour",
  timestamp: datetime('2025-11-13T15:30:00Z'),
  assetId: "rail-line-central",
  target: 12.0,
  thresholdExceeded: true,
  aggregationPeriod: duration('PT1H'),
  trend: "DEGRADING",
...
// Sample 10: Data Center Response Time
CREATE (metric10:OperationalMetric {
  metricId: "metric-datacenter-response-20251113",
  metricType: "RESPONSE_TIME",
  value: 45.0,
  unit: "milliseconds",
  timestamp: datetime('2025-11-13T15:30:00Z'),
  ...
  target: 100.0,
  thresholdExceeded: false,
  aggregationPeriod: duration('PT1M'),
  trend: "STABLE",
...
// ==============================================================================
// CG-9 Node Type 2: ServiceLevel (10 samples)
// ==============================================================================

// Sample 1: High-Speed Rail Service SLA
CREATE (sla1:ServiceLevel {
  slaId: "sla-high-speed-rail-20251113",
  serviceName: "High-Speed Rail Service",
  availabilityTarget: 99.95,
  responseTimeTarget: duration('PT4H'),
  throughputTarget: 12.0,
  penaltyPerHourDowntime: 100000.0,
  currency: "EUR",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-german-rail-authority",
  currentAvailability: 97.5,
  breachStatus: true,
  breachStartTime: datetime('2025-11-13T15:30:00Z'),
  accumulatedDowntime: duration('PT3H'),
  accumulatedPenalty: 300000.0,
  customer_namespace: "customer:RailOperator-XYZ",
  is_shared: false
});

// Sample 2: Signal System Uptime SLA
CREATE (sla2:ServiceLevel {
  slaId: "sla-signal-system-20251113",
  serviceName: "Railway Signal System Uptime",
  availabilityTarget: 99.99,
  responseTimeTarget: duration('PT1H'),
  penaltyPerHourDowntime: 250000.0,
  currency: "EUR",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-german-rail-authority",
  currentAvailability: 95.0,
  breachStatus: true,
  breachStartTime: datetime('2025-11-13T15:30:15Z'),
  accumulatedDowntime: duration('PT8H'),
  accumulatedPenalty: 2000000.0,
  customer_namespace: "customer:RailOperator-XYZ",
  is_shared: false
});

// Sample 3: Water Supply SLA
CREATE (sla3:ServiceLevel {
  slaId: "sla-water-supply-20251113",
  serviceName: "Municipal Water Supply",
  availabilityTarget: 99.9,
  responseTimeTarget: duration('PT2H'),
  throughputTarget: 1200000.0,
  penaltyPerHourDowntime: 25000.0,
  currency: "EUR",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-city-water-authority",
  currentAvailability: 92.0,
  breachStatus: true,
  breachStartTime: datetime('2025-11-13T15:31:00Z'),
  accumulatedDowntime: duration('PT6H'),
  accumulatedPenalty: 150000.0,
  customer_namespace: "customer:WaterUtility-Beta",
  is_shared: false
});

// Sample 4: Power Grid Reliability SLA
CREATE (sla4:ServiceLevel {
  slaId: "sla-power-reliability-20251113",
  serviceName: "Power Grid Reliability",
  availabilityTarget: 99.95,
  responseTimeTarget: duration('PT30M'),
  penaltyPerHourDowntime: 500000.0,
  currency: "EUR",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-regional-power-authority",
  currentAvailability: 88.0,
  breachStatus: true,
  breachStartTime: datetime('2025-11-13T15:30:00Z'),
  accumulatedDowntime: duration('PT12H'),
  accumulatedPenalty: 6000000.0,
  customer_namespace: "customer:PowerGrid-Gamma",
  is_shared: false
});

// Sample 5: Manufacturing Production SLA
CREATE (sla5:ServiceLevel {
  slaId: "sla-production-uptime-20251113",
  serviceName: "Production Line Uptime",
  availabilityTarget: 98.0,
  responseTimeTarget: duration('PT8H'),
  throughputTarget: 1000.0,
  penaltyPerHourDowntime: 50000.0,
  currency: "USD",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-automotive-customer",
  currentAvailability: 0.0,
  breachStatus: true,
  breachStartTime: datetime('2025-11-13T16:00:00Z'),
  accumulatedDowntime: duration('PT24H'),
  accumulatedPenalty: 1200000.0,
  customer_namespace: "customer:Manufacturing-Lambda",
  is_shared: false
});

// Sample 6: Building Climate Control SLA
CREATE (sla6:ServiceLevel {
  slaId: "sla-climate-control-20251113",
  serviceName: "Building Climate Control",
  availabilityTarget: 99.5,
  responseTimeTarget: duration('PT2H'),
  penaltyPerHourDowntime: 10000.0,
  currency: "USD",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-building-tenants-association",
  currentAvailability: 50.0,
  breachStatus: true,
  breachStartTime: datetime('2025-11-13T17:00:00Z'),
  accumulatedDowntime: duration('PT12H'),
  accumulatedPenalty: 120000.0,
  customer_namespace: "customer:SmartBuilding-Epsilon",
  is_shared: false
});

// Sample 7: Gas Pipeline Delivery SLA
CREATE (sla7:ServiceLevel {
  slaId: "sla-gas-delivery-20251113",
  serviceName: "Natural Gas Delivery",
  availabilityTarget: 99.8,
  responseTimeTarget: duration('PT4H'),
  throughputTarget: 3500000.0,
  penaltyPerHourDowntime: 150000.0,
  currency: "EUR",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-regional-gas-authority",
  currentAvailability: 75.0,
  breachStatus: true,
  breachStartTime: datetime('2025-11-13T18:00:00Z'),
  accumulatedDowntime: duration('PT48H'),
  accumulatedPenalty: 7200000.0,
  customer_namespace: "customer:GasPipeline-Zeta",
  is_shared: false
});

// Sample 8: SCADA Monitoring SLA
CREATE (sla8:ServiceLevel {
  slaId: "sla-scada-monitoring-20251113",
  serviceName: "SCADA Monitoring System",
  availabilityTarget: 99.99,
  responseTimeTarget: duration('PT15M'),
  penaltyPerHourDowntime: 75000.0,
  currency: "EUR",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-operations-management",
  currentAvailability: 0.0,
  breachStatus: true,
  breachStartTime: datetime('2025-11-13T15:30:30Z'),
  accumulatedDowntime: duration('PT4H'),
  accumulatedPenalty: 300000.0,
  customer_namespace: "customer:RailOperator-XYZ",
  is_shared: false
});

// Sample 9: Data Center Uptime SLA
CREATE (sla9:ServiceLevel {
  slaId: "sla-datacenter-uptime-20251113",
  serviceName: "Data Center Uptime",
  availabilityTarget: 99.99,
  responseTimeTarget: duration('PT5M'),
  penaltyPerHourDowntime: 200000.0,
  currency: "USD",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-telecom-customers",
  currentAvailability: 99.99,
  breachStatus: false,
  accumulatedDowntime: duration('PT0S'),
  accumulatedPenalty: 0.0,
  customer_namespace: "customer:TelecomProvider-Kappa",
  is_shared: false
});

// Sample 10: Customer Support Response SLA
CREATE (sla10:ServiceLevel {
  slaId: "sla-support-response-20251113",
  serviceName: "Customer Support Response",
  availabilityTarget: 100.0,
  responseTimeTarget: duration('PT30M'),
  penaltyPerHourDowntime: 5000.0,
  currency: "EUR",
  contractStartDate: date('2025-01-01'),
  contractEndDate: date('2025-12-31'),
  customerId: "org-rail-passengers",
  currentAvailability: 95.0,
  breachStatus: true,
  breachStartTime: datetime('2025-11-13T15:30:00Z'),
  accumulatedDowntime: duration('PT1H'),
  accumulatedPenalty: 5000.0,
  customer_namespace: "customer:RailOperator-XYZ",
  is_shared: false
});

// ==============================================================================
// CG-9 Node Type 3: RevenueModel (10 samples)
// ==============================================================================
...
// ==============================================================================
// CG-9 Node Type 4: CustomerImpact (10 samples)
// ==============================================================================
...
// ==============================================================================
// END OF CG-9 SAMPLE DATA
// ==============================================================================
// Total CG-9 Nodes Created: 40 nodes (10 per type × 4 types)
// Coverage: OperationalMetric, ServiceLevel, RevenueModel, CustomerImpact
// Realistic data includes operational KPIs, SLA tracking, revenue models,
// and customer compensation calculations
// ==============================================================================
