// GAP-004 Sample Data: Supporting Nodes
// File: gap004_sample_data_supporting.cypher
// Created: 2025-11-13
...
CREATE (deviation3:StateDeviation {
  ...
  deviation: {
    pressure: {
      ...
      actual: 45.3,
      difference: -49.9,
      percentDeviation: -52.4
    },
    flowRate: {
      expected: 850.0,
      actual: 520.0,
      difference: -330.0,
      percentDeviation: -38.8
    }
  },
  severity: "HIGH",
...
CREATE (deviation6:StateDeviation {
  ...
  deviation: {
    lampIntensity: {
      ...
      actual: 25.0,
      difference: -70.0,
      percentDeviation: -73.7
    },
    voltage: {
      expected: 24.0,
      actual: 18.5,
      difference: -5.5,
      percentDeviation: -22.9
    }
  },
  severity: "CRITICAL",
...
CREATE (deviation7:StateDeviation {
  ...
  deviation: {
    temperature: {
      ...
      actual: 28.3,
      difference: 6.8,
      percentDeviation: 31.6
    },
    humidity: {
      expected: 45.0,
      actual: 62.0,
      difference: 17.0,
      percentDeviation: 37.8
    }
  },
  severity: "MEDIUM",
...
CREATE (deviation9:StateDeviation {
  ...
  deviation: {
    pitch: {
      ...
      actual: 15.2,
      difference: 6.7,
      percentDeviation: 78.8
    },
    rotorSpeed: {
      expected: 12.5,
      actual: 18.3,
      difference: 5.8,
      percentDeviation: 46.4
    }
  },
  severity: "CRITICAL",
...
CREATE (deviation10:StateDeviation {
  ...
  deviation: {
    temperature: {
      ...
      actual: 1385.0,
      difference: 135.0,
      percentDeviation: 10.8
    },
    pressure: {
      expected: 1.02,
      actual: 1.15,
      difference: 0.13,
      percentDeviation: 12.7
    }
  },
  severity: "CRITICAL",
...
// Realistic data includes anomalies, trends, operational impacts, and resilience metrics
// These nodes provide critical integration points between UC2, UC3, R6, and CG-9
// ==============================================================================
