...
CREATE (disrupt1:DisruptionEvent {
  ...
  incidentResponse: '{
    "responseStartTime": "2025-11-13T15:31:00Z",
...
CREATE (resilience1:SystemResilience {
  ...
  failureHistory: '[
    {"timestamp": "2025-08-15T10:00:00Z", "cause": "SOFTWARE_BUG", "duration": "PT3H"},
    {"timestamp": "2025-05-20T14:00:00Z", "cause": "POWER_OUTAGE", "duration": "PT2H"}
  ]',
  resilienceScore: 9.2,
  customer_namespace: "customer:RailOperator-XYZ",
  is_shared: false
