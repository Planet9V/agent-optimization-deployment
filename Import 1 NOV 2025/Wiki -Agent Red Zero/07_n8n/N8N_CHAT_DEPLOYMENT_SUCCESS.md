...
2. **Via API:**
   ...
   curl -X PATCH http://localhost:5678/api/v1/workflows/vTKLEeEORD6IHoQ9 \
     -H "X-N8N-API-KEY: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI4ZTA5YWMyYS05NTE5LTRhMWYtODE1ZS1kYzE5MGUxY2Y1YjciLCJpc3MiOiJuOG4iLCJhdWQiOiJwdWJsaWMtYXBpIiwiaWF0IjoxNzYwNzY1MTEwfQ.r8y-3bLzp9WlVh6uwCUbSd19ORqu0zIMrHBH5oJ3H6A" \
...
- **Workflow Specification:** `N8N_CHAT_WORKFLOW_SPECIFICATION.md`
- **Node Reference:** `N8N_NODE_REFERENCE.md`
- **n8n MCP Installation:** `N8N_MCP_COMPREHENSIVE_INSTALLATION.md`
