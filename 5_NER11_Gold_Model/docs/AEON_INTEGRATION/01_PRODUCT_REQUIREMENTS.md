...
## NER11 Gold Capabilities
The system integrates the NER11 Gold Standard model to fulfill the following requirements:

1. **High-Precision Extraction**: Supports 566 entity types with >93% F1 score.
2. **Real-Time API**: Provides sub-100ms inference via FastAPI.
3. **Neo4j Integration**: Native pipeline support for knowledge graph population.
4. **Local Data Sovereignty**: All training data is stored locally and fully preserved.
