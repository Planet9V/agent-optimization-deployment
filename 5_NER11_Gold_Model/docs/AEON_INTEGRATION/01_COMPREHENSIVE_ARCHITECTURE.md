...
## NER11 Gold Service Integration
The NER11 Gold Model is integrated as a containerized microservice within the AEON architecture.

### Component Specification
- **Service Name**: `ner11-gold-api`
- **Container Image**: `ner11-gold-api:latest`
- **Port**: 8000 (Internal/External)
- **Runtime**: Python 3.12, FastAPI, spaCy v3.7 (GPU Accelerated)

### Interaction Flow
1. **Client Request**: Services (e.g., Neo4j Pipeline, Web Frontend) send POST requests to `/ner`.
2. **Entity Extraction**: The spaCy model processes text and extracts entities (566 types).
3. **Response**: JSON payload containing entities, labels, and confidence scores is returned.
