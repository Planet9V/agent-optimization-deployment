            ...
            <div className="p-4 space-y-2">
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform duration-200 ${openDropdown === 'investigate-mobile' ? 'rotate-180' : ''
                      }`}
                  />
                </button>
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform duration-200 ${openDropdown === 'analyze-mobile' ? 'rotate-180' : ''
                      }`}
                  />
                </button>
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform duration-200 ${openDropdown === 'manage-mobile' ? 'rotate-180' : ''
                      }`}
                  />
                </button>
