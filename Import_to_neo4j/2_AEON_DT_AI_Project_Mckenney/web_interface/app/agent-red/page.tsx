...
import AgentRedVisualization from '../../components/agent-red/AgentRedVisualization';
import SectorGrid from '../../components/agent-red/SectorGrid';

export default function AgentRedPage() {
    return (
        <div className="min-h-screen bg-dark text-gray-300 font-sans selection:bg-primary/30 selection:text-white">
            ...
            <section className="relative z-10 min-h-screen flex flex-col p-4 md:p-8 border-b border-white/5">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 space-y-32">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    {/* New Dense Matrix Visualization instead of the Circle */}
                    <div className="bg-dark-lighter p-8 rounded-xl border border-white/10 relative shadow-[0_0_50px_rgba(0,0,0,0.5)] overflow-hidden">
                        <div className="absolute inset-0 bg-[linear-gradient(rgba(0,170,255,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(0,170,255,0.05)_1px,transparent_1px)] bg-[size:20px_20px]"></div>
                        <div className="relative z-10">
                            <div className="flex justify-between items-center mb-6 border-b border-white/10 pb-4">
                                <h4 className="text-xl font-bold text-white">PSYCHOMETRIC TOPOLOGY MATRIX</h4>
                                <span className="text-xs font-mono text-primary animate-pulse">LIVE FEED</span>
                            </div>
                            <div className="grid grid-cols-3 gap-2 font-mono text-xs">
                                <div className="bg-black/40 p-2 border border-white/5 text-gray-400">NODE_ID</div>
                                <div className="bg-black/40 p-2 border border-white/5 text-gray-400">TYPE</div>
                                <div className="bg-black/40 p-2 border border-white/5 text-gray-400">VALENCE</div>

                                <div className="bg-surface/50 p-2 border border-white/5 text-white">SOC_LEAD_01</div>
                                <div className="bg-surface/50 p-2 border border-white/5 text-secondary">ANALYST</div>
                                <div className="bg-surface/50 p-2 border border-white/5 text-red-400">0.89 (HIGH)</div>

                                <div className="bg-surface/50 p-2 border border-white/5 text-white">CISO_EXEC</div>
                                <div className="bg-surface/50 p-2 border border-white/5 text-secondary">MASTER</div>
                                <div className="bg-surface/50 p-2 border border-white/5 text-yellow-400">0.42 (MED)</div>

                                <div className="bg-surface/50 p-2 border border-white/5 text-white">DEV_OPS_04</div>
                                <div className="bg-surface/50 p-2 border border-white/5 text-secondary">HYSTERIC</div>
                                <div className="bg-surface/50 p-2 border border-white/5 text-green-400">0.12 (LOW)</div>
                            </div>
                            <div className="mt-6 h-32 bg-black/40 border border-white/5 rounded relative overflow-hidden">
                                {/* Simulated Graph Lines */}
                                <svg className="absolute inset-0 w-full h-full opacity-30">
                                    <path d="M10,50 Q100,10 200,50 T400,50" fill="none" stroke="#00aaff" strokeWidth="2" />
                                    <path d="M10,80 Q150,120 300,80" fill="none" stroke="#00e0b0" strokeWidth="2" />
                                    <circle cx="200" cy="50" r="4" fill="#00aaff" />
                                    <circle cx="300" cy="80" r="4" fill="#00e0b0" />
                                </svg>
                            </div>
                        </div>
                    </div>
