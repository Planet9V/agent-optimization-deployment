#!/usr/bin/env python3
"""
NVD API CVE Import Script for 2018-2019
Imports ~35,000-40,000 CVEs from the NVD API v2.0 into Neo4j
...
# Progress tracking
PROGRESS_FILE = ".nvd_import_progress.json"
...
class NVDImporter:
    ...
    def load_progress(self):
        ...
        if Path(PROGRESS_FILE).exists():
            ...
            self.progress = {
                'last_processed_date': '2018-01-01T00:00:00.000',
                'total_processed': 0,
...
def main():
    ...
    logger.info("="*60)
    logger.info("NVD CVE Import Script - 2018-2019")
    logger.info("="*60)
    logger.info(f"Start time: {datetime.now()}")
    logger.info(f"Target: ~35,000-40,000 CVEs from 2018-2019")
    ...
    try:
        with NVDImporter() as importer:
            ...
            # Import 2018-2019 CVEs
            importer.import_year_range(2018, 2019)
