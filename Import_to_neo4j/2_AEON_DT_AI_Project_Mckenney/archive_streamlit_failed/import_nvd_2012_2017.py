...
class NVDImporter:
    ...
    def load_progress(self):
        ...
        if Path(PROGRESS_FILE).exists():
            ...
            self.progress = {
                'last_processed_date': '2012-01-01T00:00:00.000',
                'total_processed': 0,
...
def main():
    ...
    logger.info("="*60)
    logger.info("NVD CVE Import Script - 2012-2017")
    logger.info("="*60)
    logger.info(f"Start time: {datetime.now()}")
    logger.info(f"Target: CVEs from 2012-2017 (filling gaps)")
    ...
    try:
        with NVDImporter() as importer:
            ...
            # Import 2012-2017 CVEs
            importer.import_year_range(2012, 2017)
