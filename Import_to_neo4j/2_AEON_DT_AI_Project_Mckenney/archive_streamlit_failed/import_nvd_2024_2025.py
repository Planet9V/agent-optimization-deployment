#!/usr/bin/env python3
"""
NVD API CVE Import Script for 2024-2025
Imports ~35,000 (through Oct 2025) CVEs from the NVD API v2.0 into Neo4j
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('nvd_import_2024_2025.log'),
...
# Progress tracking
PROGRESS_FILE = ".nvd_import_progress_2024_2025.json"
...
class NVDImporter:
    ...
    def load_progress(self):
        ...
        if Path(PROGRESS_FILE).exists():
            ...
            self.progress = {
                'last_processed_date': '2024-01-01T00:00:00.000',
                'total_processed': 0,
...
def main():
    ...
    logger.info("="*60)
    logger.info("NVD CVE Import Script - 2024-2025")
    logger.info("="*60)
    logger.info(f"Start time: {datetime.now()}")
    logger.info(f"Target: ~35,000 (through Oct 2025) CVEs from 2024-2025")
    ...
    try:
        with NVDImporter() as importer:
            ...
            # Import 2024-2025 CVEs
            importer.import_year_range(2024, 2025)
