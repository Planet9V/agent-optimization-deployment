#!/usr/bin/env python3
"""
NVD API CVE Import Script for 2022-2023
Imports ~50,000-52,000 CVEs from the NVD API v2.0 into Neo4j

Features:
- NVD API v2.0 compliance with rate limiting (5 req/30s)
- Date range: 2022-01-01 to 2019-12-31
...
# Progress tracking
PROGRESS_FILE = ".nvd_import_progress_2022_2023.json"
...
class NVDImporter:
    ...
    def load_progress(self):
        ...
        if Path(PROGRESS_FILE).exists():
            ...
            self.progress = {
                'last_processed_date': '2022-01-01T00:00:00.000',
                'total_processed': 0,
...
def main():
    ...
    logger.info("="*60)
    logger.info("NVD CVE Import Script - 2022-2023")
    logger.info("="*60)
    logger.info(f"Start time: {datetime.now()}")
    logger.info(f"Target: ~50,000-52,000 CVEs from 2022-2023")
    ...
    try:
        with NVDImporter() as importer:
            ...
            # Import 2022-2023 CVEs
            importer.import_year_range(2022, 2023)
